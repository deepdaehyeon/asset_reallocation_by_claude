...
레짐 감지: 규칙 기반 + GaussianHMM(5상태) 앙상블. 신뢰도 40% 미달 → Slowdown 폴백. 히스테리시스(3회 연속 확인 + 5일 쿨다운).
...
| equity_individual | 20% | 10% | 10% | 8% | 5% |
| commodity (DBC) | 5% | 16% | 5% | 18% | 5% |
| managed_futures (DBMF) | 5% | 5% | 12% | 12% | 12% |
| bond_usd | 0% | 0% | 12% | 5% | 10% |
| bond_krw | 0% | 0% | 15% | 0% | 10% |
| gold | 10% | 15% | 14% | 18% | 15% |
| cash | 15% | 17% | 12% | 26% | 40% |
...
- **Synthetic Exposure**: 버퍼 부족 시 USD 매수를 지연하되 KRW 동등 자산으로 임시 노출 유지. 다음 실행 사이클에서 자동 정리.
