...
> 생성: **2026-08-31 10:01 KST** · 마지막 실행: 2026-08-31 05:00
...
| 마지막 전환일 | 2026-08-03 |
| 신뢰도 | 40.92% |
| HMM 매핑 | unsupervised (실행 95회, legacy 폴백 0회) |
...
| 총자산 | ₩228,343,640 |
| 원금 | ₩234,116,490 |
| 누적 손익 | ₩-5,772,850 (-2.47%) |
| 고점 | ₩228,809,509 |
| 드로우다운 | -0.20% |
| S&P500였다면 | ₩228,240,126 |
| **알파(vs S&P500)** | **₩103,514 (+0.05%)** |
| 이번 달 회전액 | ₩192,694,567 (2026-08) |
...
|---|---|---|---|---|
| KRW | 4.49% | ⚪ | no_trigger(drift=4.5%) | 2026-08-28 10:19 |
| USD | 4.49% | ⚪ | no_trigger(drift=4.5%) | 2026-08-29 03:03 |
