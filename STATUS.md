...
> 생성: **2026-08-26 03:01 KST** · 마지막 실행: 2026-08-26 03:01
...
| 마지막 전환일 | 2026-08-03 |
| 신뢰도 | 48.61% |
| HMM 매핑 | unsupervised (실행 92회, legacy 폴백 0회) |
...
| 총자산 | ₩235,109,703 |
| 원금 | ₩240,016,724 |
| 누적 손익 | ₩-4,907,021 (-2.04%) |
| 고점 | ₩235,109,703 |
| 드로우다운 | 0.00% |
| S&P500였다면 | ₩201,116,074 |
| **알파(vs S&P500)** | **₩33,993,629 (+16.90%)** |
...
|---|---|---|---|---|
| KRW | 3.57% | ⚪ | no_trigger(drift=3.6%) | 2026-08-25 10:19 |
| USD | 3.57% | ⚪ | no_trigger(drift=3.6%) | 2026-08-25 03:01 |
