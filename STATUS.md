...
> 생성: **2026-09-07 10:00 KST** · 마지막 실행: 2026-09-07 05:01
...
| 마지막 전환일 | 2026-08-03 |
| 신뢰도 | 31.23% |
| HMM 매핑 | unsupervised (실행 101회, legacy 폴백 0회) |
...
| 총자산 | ₩229,060,042 |
| 원금 | ₩235,645,304 |
| 누적 손익 | ₩-6,585,261 (-2.79%) |
| 고점 | ₩233,356,367 |
| 드로우다운 | -1.84% |
| S&P500였다면 | ₩227,552,552 |
| **알파(vs S&P500)** | **₩1,507,491 (+0.66%)** |
| 이번 달 회전액 | ₩54,896,035 (2026-09) |
...
|---|---|---|---|---|
| KRW | 3.99% | ⚪ | no_trigger(drift=4.0%) | 2026-09-04 10:00 |
| USD | 3.99% | ⚪ | no_trigger(drift=4.0%) | 2026-09-05 03:02 |
