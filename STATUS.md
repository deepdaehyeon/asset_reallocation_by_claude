...
> 생성: **2026-09-03 09:45 KST** · 마지막 실행: 2026-09-03 03:01
...
| 마지막 전환일 | 2026-08-03 |
| 신뢰도 | 39.89% |
| HMM 매핑 | unsupervised (실행 98회, legacy 폴백 0회) |
...
| 총자산 | ₩229,979,096 |
| 원금 | ₩237,842,346 |
| 누적 손익 | ₩-7,863,250 (-3.31%) |
| 고점 | ₩234,439,122 |
| 드로우다운 | -1.90% |
| S&P500였다면 | ₩229,217,080 |
| **알파(vs S&P500)** | **₩762,016 (+0.33%)** |
...
|---|---|---|---|---|
| KRW | 3.37% | ⚪ | no_trigger(drift=3.4%) | 2026-09-01 10:19 |
| USD | 3.37% | ⚪ | no_trigger(drift=3.4%) | 2026-09-01 03:02 |
