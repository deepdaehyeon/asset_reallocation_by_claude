...
> 생성: **2026-09-16 10:00 KST** · 마지막 실행: 2026-09-16 03:02
...
| 마지막 전환일 | 2026-08-03 |
| 신뢰도 | 21.48% |
| HMM 매핑 | unsupervised (실행 109회, legacy 폴백 0회) |
...
| 총자산 | ₩229,540,949 |
| 원금 | ₩238,006,006 |
| 누적 손익 | ₩-8,465,056 (-3.56%) |
| 고점 | ₩236,067,227 |
| 드로우다운 | -2.76% |
| S&P500였다면 | ₩229,218,671 |
| **알파(vs S&P500)** | **₩322,278 (+0.14%)** |
...
|---|---|---|---|---|
| KRW | 4.23% | ⚪ | no_trigger(drift=4.2%) | 2026-09-14 10:00 |
| USD | 4.23% | ⚪ | no_trigger(drift=4.2%) | 2026-09-09 03:02 |
